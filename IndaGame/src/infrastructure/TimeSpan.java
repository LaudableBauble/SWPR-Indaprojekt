...
/**
 * @author Ashok Gelal copyright: Ashok
 */
public class TimeSpan
{
	public static final long NanosecondsPerTick = 100L;
	...
	public TimeSpan Subtract(long time)
	{
		return new TimeSpan(ticks - time);
	}
	...
	public static TimeSpan Subtract(long time1, TimeSpan time2)
	{
		return new TimeSpan(time1 - time2.Ticks());
	}
	...
	public String toString()
	{
		...
		if (days >= 1 || days <= -1) str.append(String.format("%02d.", days));

		str.append(String.format("%02d:", hours));
		str.append(String.format("%02d:", minutes));
		str.append(String.format("%02d", seconds));

		if (milliseconds >= 1) str.append(String.format(".%d%s", milliseconds, TRAILING_ZEROS.substring(Integer.toString(milliseconds).length())));
		return str.toString();
	}
