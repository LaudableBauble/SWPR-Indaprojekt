...
public class ZPlaneResolver implements ZValueResolver
{
	...
	/**
	 * Create {@link ZValueResolver} based on plane (3 points definition)
	 * 
	 * @param x1
	 *            coordinate
	 * @param x2
	...
	{
		this(Helper.getPlane(x1, x2, x3, y1, y2, y3, z1, z2, z3));
	}
	 ...
	 * 
	 * @param plane
	 *            Ax + By + Cz + D = 0 => A = plane[0], B = plane[1], C = plane[2], D = plane[3]
	 */
	...
	{
		if (plane.length != 4) { throw new IllegalArgumentException(""); }
