...
//		_CanBeControlled = true;
	...
	public void loadContent(){
		...
		for(int x = 1;x<=nrPics;x++){
			down.addFrame(new Frame("Character/"+charactern+"/"+charactern+"down"+x+".png"));
			up.addFrame(new Frame("Character/"+charactern+"/"+charactern+"up"+x+".png"));
			right.addFrame(new Frame("Character/"+charactern+"/"+charactern+"right"+x+".png"));
			left.addFrame(new Frame("Character/"+charactern+"/"+charactern+"left"+x+".png"));
		}
