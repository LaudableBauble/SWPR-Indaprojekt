...
/**
 * A sprite is either an image or a collection of images used to simulate an animation. This is now an old variant of the sprite class, kept due to laziness.
 */
