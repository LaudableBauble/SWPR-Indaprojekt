...
/**
 * A ZComposite emulates a Z-Buffer and is used to simulate depth in 2D drawing.
 * 
 * @author caiiiycuk
 */
public class ZComposite implements Composite
{
	...
	{
		if (x >= width || x < 0 || y >= height || y < 0) { throw new IllegalArgumentException("Point [" + x + ", " + y + "] is outside of the Z Buffer array"); }
